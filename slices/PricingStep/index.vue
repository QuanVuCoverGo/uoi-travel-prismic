...
defineProps(
  getSliceComponentProps<Content.PricingStepSlice>([
    "slice",
    "index",
    "slices",
    "context",
        ...
        <v-row class="header-row">
          ...
          <v-col class="pa-0 h-100" v-if="planPrice?.basic">
            ...
            >
              ...
              <p class="text-description">
                {{ slice.primary.basic_plan_description || "" }}
              </p>
          ...
          <v-col class="pa-0 h-100" v-if="planPrice?.essential">
            ...
            >
              ...
              <p class="text-description">
                {{ slice.primary.essential_plan_description || "" }}
              </p>
              <div class="d-flex justify-center align-center ga-2">
                <p
                  :class="isApplied ? 'costPrice' : 'discounted-price'"
          ...
          <v-col class="pa-0 h-100" v-if="planPrice?.preferred">
            ...
            >
              ...
              <p class="text-description">
                {{ slice.primary.preferred_plan_description || "" }}
              </p>
              <div class="d-flex justify-center align-center ga-2">
                <p
                  :class="isApplied ? 'costPrice' : 'discounted-price'"
